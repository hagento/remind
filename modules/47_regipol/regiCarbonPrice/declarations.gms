...
$ifThen.regiExoPrice1 "%cm_regiExoPrice%" == "1"
Parameter
...
$else.regiExoPriceType
  p47_exoCo2tax(ext_regi,ttot)   "Exogenous CO2 tax level. Overrides carbon prices in pm_taxCO2eq, only if explicitly defined. Regions and region groups allowed. Format: '<regigroup>.<year> <value>, <regigroup>.<year2> <value2>' or '<regigroup>.(<year1> <value>,<year2> <value>'). [$/tCO2]"
  /  
   CAZ.(2020 0, 2025 8.8, 2030 8.8, 2035 15, 2040 21.5, 2045 26.8, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   CHA.(2020 0, 2025 2.2, 2030 2.4, 2035 9.1, 2040 15.1, 2045 22.4, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   EUR.(2020 5, 2025 11, 2030 11, 2035 15, 2040 21.5, 2045 26.8, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   IND.(2020 0, 2025 0.5, 2030 0.9, 2035 5.5, 2040 11.2, 2045 19.7, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   JPN.(2020 0, 2025 6.6, 2030 6.6, 2035 15, 2040 21.5, 2045 26.8, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   LAM.(2020 0, 2025 4.4, 2030 4.4, 2035 10.8, 2040 17, 2045 23.7, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   MEA.(2020 0, 2025 1.1, 2030 2.2, 2035 10.8, 2040 17, 2045 23.7, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   NEU.(2020 2.5, 2025 4.4, 2030 4.4, 2035 13.8, 2040 20.2, 2045 25.9, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   OAS.(2020 0, 2025 2.2, 2030 2.2, 2035 6.7, 2040 12.5, 2045 20.6, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   REF.(2020 0, 2025 1.1, 2030 2.5, 2035 12.6, 2040 18.9, 2045 25, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   SSA.(2020 0, 2025 0.5, 2030 0.9, 2035 5.5, 2040 11.2, 2045 19.7, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   USA.(2020 0, 2025 8.8, 2030 8.8, 2035 15, 2040 21.5, 2045 26.8, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
   GLO.(2020 0, 2025 8.8, 2030 8.8, 2035 15, 2040 21.5, 2045 26.8, 2050 32.7, 2055 41.9, 2060 53.3, 2070 82.2, 2080 121.3, 2090 173.9, 2100 240)
  /
  ;
...
$ifThen.regiExoPrice2 "%cm_regiExoPrice%" == "2"
Parameter
$ifThen.regiExoPriceType "%cm_regiExoPrice%" == "gdx" 
  p47_tau_taxemiMkt(ttot,all_regi,emiMkt)   "emiMkt CO2eq prices loaded from input gdx, in T$/GtC = $/kgC. To get $/tCO2, multiply with 272 [T$/GtC]"
$else.regiExoPriceType
  p47_exoCo2tax(ext_regi,ttot)   "Exogenous CO2 tax level. Overrides carbon prices in pm_taxCO2eq, only if explicitly defined. Regions and region groups allowed. Format: '<regigroup>.<year> <value>, <regigroup>.<year2> <value2>' or '<regigroup>.(<year1> <value>,<year2> <value>'). [$/tCO2]"
  /  
   CAZ.(2020 0, 2025 9.68, 2030 9.68, 2035 16.5, 2040 23.65, 2045 29.48, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   CHA.(2020 0, 2025 2.42, 2030 2.64, 2035 10.01, 2040 16.61, 2045 24.64, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   EUR.(2020 5.5, 2025 12.1, 2030 12.1, 2035 16.5, 2040 23.65, 2045 29.48, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   IND.(2020 0, 2025 0.55, 2030 0.99, 2035 6.05, 2040 12.32, 2045 21.67, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   JPN.(2020 0, 2025 7.26, 2030 7.26, 2035 16.5, 2040 23.65, 2045 29.48, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   LAM.(2020 0, 2025 4.84, 2030 4.84, 2035 11.88, 2040 18.7, 2045 26.07, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   MEA.(2020 0, 2025 1.21, 2030 2.42, 2035 11.88, 2040 18.7, 2045 26.07, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   NEU.(2020 2.75, 2025 4.84, 2030 4.84, 2035 15.18, 2040 22.22, 2045 28.49, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   OAS.(2020 0, 2025 2.42, 2030 2.42, 2035 7.37, 2040 13.75, 2045 22.66, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   REF.(2020 0, 2025 1.21, 2030 2.75, 2035 13.86, 2040 20.79, 2045 27.5, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   SSA.(2020 0, 2025 0.55, 2030 0.99, 2035 6.05, 2040 12.32, 2045 21.67, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   USA.(2020 0, 2025 9.68, 2030 9.68, 2035 16.5, 2040 23.65, 2045 29.48, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
   GLO.(2020 0, 2025 9.68, 2030 9.68, 2035 16.5, 2040 23.65, 2045 29.48, 2050 35.97, 2055 46.09, 2060 58.63, 2070 90.42, 2080 133.43, 2090 191.29, 2100 264)
  /
  ;
$endIf.regiExoPriceType
;
...
$ifThen.regiExoPrice3 "%cm_regiExoPrice%" == "3"
Parameter
$ifThen.regiExoPriceType "%cm_regiExoPrice%" == "gdx" 
  p47_tau_taxemiMkt(ttot,all_regi,emiMkt)   "emiMkt CO2eq prices loaded from input gdx, in T$/GtC = $/kgC. To get $/tCO2, multiply with 272 [T$/GtC]"
$else.regiExoPriceType
  p47_exoCo2tax(ext_regi,ttot)   "Exogenous CO2 tax level. Overrides carbon prices in pm_taxCO2eq, only if explicitly defined. Regions and region groups allowed. Format: '<regigroup>.<year> <value>, <regigroup>.<year2> <value2>' or '<regigroup>.(<year1> <value>,<year2> <value>'). [$/tCO2]"
  /  
   CAZ.(2020 0.0, 2025 11.0, 2030 11.0, 2035 18.8, 2040 26.9, 2045 33.5, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   CHA.(2020 0.0, 2025 2.8, 2030 3.0, 2035 11.4, 2040 18.9, 2045 28.0, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   EUR.(2020 6.2, 2025 13.8, 2030 13.8, 2035 18.8, 2040 26.9, 2045 33.5, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   IND.(2020 0.0, 2025 0.6, 2030 1.1, 2035 6.9, 2040 14.0, 2045 24.6, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   JPN.(2020 0.0, 2025 8.2, 2030 8.2, 2035 18.8, 2040 26.9, 2045 33.5, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   LAM.(2020 0.0, 2025 5.5, 2030 5.5, 2035 13.5, 2040 21.2, 2045 29.6, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   MEA.(2020 0.0, 2025 1.4, 2030 2.8, 2035 13.5, 2040 21.2, 2045 29.6, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   NEU.(2020 3.1, 2025 5.5, 2030 5.5, 2035 17.2, 2040 25.2, 2045 32.4, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   OAS.(2020 0.0, 2025 2.8, 2030 2.8, 2035 8.4, 2040 15.6, 2045 25.8, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   REF.(2020 0.0, 2025 1.4, 2030 3.1, 2035 15.8, 2040 23.6, 2045 31.2, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   SSA.(2020 0.0, 2025 0.6, 2030 1.1, 2035 6.9, 2040 14.0, 2045 24.6, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   USA.(2020 0.0, 2025 11.0, 2030 11.0, 2035 18.8, 2040 26.9, 2045 33.5, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
   GLO.(2020 0.0, 2025 11.0, 2030 11.0, 2035 18.8, 2040 26.9, 2045 33.5, 2050 40.9, 2055 52.4, 2060 66.6, 2070 102.8, 2080 151.6, 2090 217.4, 2100 300.0)
  /
  ;
$endIf.regiExoPriceType
;
